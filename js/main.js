  ...
  <div class="footer-grid">
    ...
    <div>
      ...
      <div class="quality-badge">
        <div class="quality-badge-title">QUALITY<br>CONTROL</div>
        <div class="quality-badge-sub">FOUST BROS APPROVED<br>WD-CERTIFIED <span style="color:var(--cyan)">●</span></div>
      </div>
    </div>
  </div>
...
<footer>
  <div class="footer-grid">
    <div><div class="footer-brand-header"><div><div class="footer-brand-name">FOUST BROTHERS</div><div class="footer-brand-sub">DIGITAL DIVISION</div></div></div><p class="footer-tagline">Expert digital craftsmen operating with the same precision and commitment to excellence as a master-level shop.</p><div class="footer-motto">UNDER PROMISE.<br>OVER DELIVER.</div></div>
    <div><div class="footer-section-label">// CONTACT</div><div class="footer-contact-item"><div class="footer-contact-label">PHONE</div><div class="footer-contact-value"><a href="tel:3368622999">(336) 862-2999</a></div></div><div class="footer-contact-item"><div class="footer-contact-label">EMAIL</div><div class="footer-contact-value"><a href="mailto:FoustBrothersLLC@gmail.com">FoustBrothersLLC@gmail.com</a></div></div></div>
    <div><div class="footer-section-label">// QUICK NAV</div><ul class="footer-nav-links"><li><a onclick="navigate('home')">HOME</a></li><li><a onclick="navigate('work-order')">WORK ORDER</a></li><li><a onclick="navigate('billing')">BILLING</a></li></ul></div>
  </div>
  <div class="footer-bottom"><div class="footer-copy">© <span class="footerYear"></span> FOUST BROTHERS LLC. All rights reserved.</div><div class="footer-legal-links"><a onclick="navigate('privacy')">PRIVACY POLICY</a><a onclick="navigate('terms')">TERMS OF SERVICE</a></div><div class="footer-philosophy">PHILOSOPHY: UNDER PROMISE — OVER DELIVER</div></div>
</footer>
</div><!-- /page-about -->
  ...
  <div class="container">
    ...
    <div class="rate-table">
      ...
      <div class="rate-row rate-row-active">
        <div class="rate-row-left"><div class="rate-dot cyan"></div><div><div class="rate-tier">TIER 1 — SIMPLE / INFORMATIONAL SITE</div><div class="rate-sub">Best for: Local service businesses needing a clean professional presence.</div><div style="margin-top:.6rem;font-family:var(--font-mono);font-size:.6rem;color:var(--white-dim);line-height:1.8;"><span style="color:var(--cyan)">›</span> Up to 3 main pages (Home, Services, Contact)<br><span style="color:var(--cyan)">›</span> Custom layout &amp; mobile optimization<br><span style="color:var(--cyan)">›</span> Basic contact form included</div></div></div>
      ...
      <div class="rate-row">
        <div class="rate-row-left"><div class="rate-dot cyan"></div><div><div class="rate-tier">TIER 2 — STANDARD GROWTH SITE</div><div class="rate-sub">Best for: Established businesses showcasing portfolios, service menus, or generating active leads.</div><div style="margin-top:.6rem;font-family:var(--font-mono);font-size:.6rem;color:var(--white-dim);line-height:1.8;"><span style="color:var(--cyan)">›</span> Up to 6 pages<br><span style="color:var(--cyan)">›</span> Advanced forms (scheduling/booking hooks)<br><span style="color:var(--cyan)">›</span> Custom dynamic elements &amp; baseline SEO</div></div></div>
      ...
      <div class="rate-row">
        <div class="rate-row-left"><div class="rate-dot"></div><div><div class="rate-tier">TIER 3 — ADVANCED CUSTOM SITE</div><div class="rate-sub">Best for: Complex builds requiring advanced functionality.</div><div style="margin-top:.6rem;font-family:var(--font-mono);font-size:.6rem;color:var(--white-dim);line-height:1.8;"><span style="color:var(--cyan)">›</span> Multi-page layouts &amp; deep integrations<br><span style="color:var(--cyan)">›</span> Dynamic database filtering<br><span style="color:var(--cyan)">›</span> Lightweight e-commerce setup</div></div></div>
...
<section style="padding-top:0;padding-bottom:2rem">
  <div class="container">
    ...
    <div class="rate-table">
      ...
      <div class="rate-row rate-row-active"><div class="rate-row-left"><div class="rate-dot cyan"></div><div><div class="rate-tier">MONTHLY RETAINER</div><div class="rate-sub">Full management, hosting, &amp; security — no contracts</div></div></div><div class="rate-amount-block"><div class="rate-amount cyan" data-cms="price_retainer_mo">$25</div><div class="rate-amount-unit">/ MO</div></div></div>
      <div class="rate-row"><div class="rate-row-left"><div class="rate-dot cyan"></div><div><div class="rate-tier">ANNUAL RETAINER <span style="color:#00ff88;font-size:.6rem;letter-spacing:.1em;margin-left:8px">15% OFF — SAVE $45</span></div><div class="rate-sub">Same full plan, billed annually</div></div></div><div class="rate-amount-block"><div class="rate-amount cyan" data-cms="price_retainer_yr">$255</div><div class="rate-amount-unit">/ YR</div></div></div>
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5px;background:var(--border);border:1px solid var(--border);margin-top:2rem;">
      <div style="background:var(--bg-card);padding:1.5rem;"><div style="font-family:var(--font-mono);font-size:.55rem;color:var(--cyan);letter-spacing:.2em;margin-bottom:1rem;padding-bottom:.5rem;border-bottom:1px solid var(--border);">// INFRASTRUCTURE &amp; SECURITY</div><div style="font-family:var(--font-mono);font-size:.6rem;color:var(--white-dim);line-height:2;"><div><span style="color:var(--cyan)">›</span> Premium Cloud Hosting &amp; SSL Certification</div><div><span style="color:var(--cyan)">›</span> 24/7 Automated Uptime &amp; Security Monitoring</div><div><span style="color:var(--cyan)">›</span> Core Framework, Plugin &amp; Database Updates</div></div></div>
      <div style="background:var(--bg-card);padding:1.5rem;"><div style="font-family:var(--font-mono);font-size:.55rem;color:var(--cyan);letter-spacing:.2em;margin-bottom:1rem;padding-bottom:.5rem;border-bottom:1px solid var(--border);">// MAINTENANCE SUPPORT</div><div style="font-family:var(--font-mono);font-size:.6rem;color:var(--white-dim);line-height:2;"><div><span style="color:var(--cyan)">›</span> Quick Content Edits (up to 30 min/mo)</div><div style="font-size:.55rem;color:rgba(138,168,184,0.6);margin-top:.25rem;padding-left:1rem;">Larger adjustments fall to Standard Shop Rate</div></div></div>
    </div>
  </div>
</section>
<section style="padding-top:0;padding-bottom:2rem">
...
<footer>
  <div class="footer-grid">
    <div><div class="footer-brand-header"><div><div class="footer-brand-name">FOUST BROTHERS</div><div class="footer-brand-sub">DIGITAL DIVISION</div></div></div><p class="footer-tagline">Transparent, flat-rate pricing with zero hidden fees.</p><div class="footer-motto">UNDER PROMISE.<br>OVER DELIVER.</div></div>
    <div><div class="footer-section-label">// QUICK LINKS</div><ul class="footer-nav-links"><li><a onclick="navigate('home')">HOME</a></li><li><a onclick="navigate('about')">ABOUT</a></li><li><a onclick="navigate('work-order')">WORK ORDER</a></li></ul></div>
    <div><div class="footer-section-label">// CONTACT</div><div class="footer-contact-item"><div class="footer-contact-label">PHONE</div><div class="footer-contact-value"><a href="tel:3368622999">(336) 862-2999</a></div></div><div class="footer-contact-item"><div class="footer-contact-label">EMAIL</div><div class="footer-contact-value"><a href="mailto:FoustBrothersLLC@gmail.com">FoustBrothersLLC@gmail.com</a></div></div></div>
  </div>
  <div class="footer-bottom"><div class="footer-copy">© <span class="footerYear"></span> FOUST BROTHERS LLC. All rights reserved.</div><div class="footer-legal-links"><a onclick="navigate('privacy')">PRIVACY POLICY</a><a onclick="navigate('terms')">TERMS OF SERVICE</a></div><div class="footer-philosophy">PHILOSOPHY: UNDER PROMISE — OVER DELIVER<br>COMMITMENT: LOCAL RELIABILITY &amp; CLEAR AGREEMENTS</div></div>
</footer>
</div><!-- /page-billing -->
...
<footer>
  <div class="footer-grid">
    <div><div class="footer-brand-header"><div><div class="footer-brand-name">FOUST BROTHERS</div><div class="footer-brand-sub">DIGITAL DIVISION</div></div></div><p class="footer-tagline">Expert digital craftsmen. Honest quotes. Reliable delivery.</p><div class="footer-motto">UNDER PROMISE.<br>OVER DELIVER.</div></div>
    <div><div class="footer-section-label">// CONTACT</div><div class="footer-contact-item"><div class="footer-contact-label">PHONE</div><div class="footer-contact-value"><a href="tel:3368622999">(336) 862-2999</a></div></div><div class="footer-contact-item"><div class="footer-contact-label">EMAIL</div><div class="footer-contact-value"><a href="mailto:FoustBrothersLLC@gmail.com">FoustBrothersLLC@gmail.com</a></div></div></div>
    <div><div class="footer-section-label">// QUICK NAV</div><ul class="footer-nav-links"><li><a onclick="navigate('home')">HOME</a></li><li><a onclick="navigate('about')">ABOUT</a></li><li><a onclick="navigate('billing')">BILLING</a></li></ul></div>
  </div>
  <div class="footer-bottom"><div class="footer-copy">© <span class="footerYear"></span> FOUST BROTHERS LLC. All rights reserved.</div><div class="footer-legal-links"><a onclick="navigate('privacy')">PRIVACY POLICY</a><a onclick="navigate('terms')">TERMS OF SERVICE</a></div><div class="footer-philosophy">PHILOSOPHY: UNDER PROMISE — OVER DELIVER</div></div>
</footer>
</div><!-- /page-work-order -->
...
<div id="adminSecretTrigger" style="position:fixed;bottom:0;left:0;width:50px;height:50px;z-index:9000;cursor:default;user-select:none;background:transparent;pointer-events:all;"></div>
